...
begin
    ...
    stim_proc: process begin
        ...
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_ShamtSrc="01" and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="0100" and t_FlagW="111" and t_isArithmeticDP='1') report "Failed Decoder Test Case 6" severity error;
        ...
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_ShamtSrc="01" and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="0010" and t_FlagW="111" and t_isArithmeticDP='1') report "Failed Decoder Test Case 8" severity error;
        ...
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_ShamtSrc="01" and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="0000" and t_FlagW="110" and t_isArithmeticDP='0') report "Failed Decoder Test Case 10" severity error;
        ...
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_ShamtSrc="01" and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="1100" and t_FlagW="110" and t_isArithmeticDP='0') report "Failed Decoder Test Case 12" severity error;
        ...
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_ShamtSrc="01" and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="0001" and t_FlagW="000" and t_isArithmeticDP='0') report "Failed Decoder Test Case 14" severity error;
        ...
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_ShamtSrc="01" and t_RegSrc="000" and t_NoWrite='1' and t_ALUControl="1001" and t_FlagW="110" and t_isArithmeticDP='0') report "Failed Decoder Test Case 16" severity error;
        ...
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_ShamtSrc="01" and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="1101" and t_FlagW="000" and t_isArithmeticDP='0') report "Failed Decoder Test Case 18" severity error;
        ...
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_ShamtSrc="01" and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="1110" and t_FlagW="000" and t_isArithmeticDP='0') report "Failed Decoder Test Case 20" severity error;
        ...
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_ShamtSrc="01" and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="1111" and t_FlagW="000" and t_isArithmeticDP='0') report "Failed Decoder Test Case 22" severity error;
        ...
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_ShamtSrc="01" and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="0011" and t_FlagW="111" and t_isArithmeticDP='1') report "Failed Decoder Test Case 36" severity error;
        ...
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_ShamtSrc="01" and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="0110" and t_FlagW="111" and t_isArithmeticDP='1') report "Failed Decoder Test Case 40" severity error;
