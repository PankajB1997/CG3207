...
begin
    ...
    stim_proc: process begin
        ...
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='0' and t_MemW='1' and t_ALUSrc='1' and t_ImmSrc="01" and t_RegSrc="010" and t_NoWrite='0' and t_ALUControl="00" and t_FlagW="00") report "Failed Decoder Test Case 2" severity error;

        -- Test case 2.1: Memory (STR) Instruction with negative offset
        t_Rd <= "0001"; t_Op <= "01"; t_Funct(0) <= '0'; t_Funct(3) <= '0';
        wait for 5 ns;
        assert (t_PCS ='0' and t_RegW='0' and t_MemW='1' and t_ALUSrc='1' and t_ImmSrc="01" and t_RegSrc="010" and t_NoWrite='0' and t_ALUControl="01" and t_FlagW="00") report "Failed Decoder Test 2.1" severity error;
        ...
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="00" and t_FlagW="00") report "Failed Decoder Test Case 5" severity error;

        -- Test case 6: DP Reg (ADDS) Instruction
        t_Rd <= "0100"; t_Op <= "00"; t_Funct <= "001001";
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="00" and t_FlagW="11") report "Failed Decoder Test Case 6" severity error;

        -- Test case 7: DP Reg (SUB) Instruction
        t_Rd <= "0101"; t_Op <= "00"; t_Funct <= "000100";
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="01" and t_FlagW="00") report "Failed Decoder Test Case 7" severity error;

        -- Test case 8: DP Reg (SUBS) Instruction
        t_Rd <= "0110"; t_Op <= "00"; t_Funct <= "000101";
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="01" and t_FlagW="11") report "Failed Decoder Test Case 8" severity error;

        -- Test case 9: DP Reg (AND) Instruction
        t_Rd <= "0111"; t_Op <= "00"; t_Funct <= "000000";
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="10" and t_FlagW="00") report "Failed Decoder Test Case 9" severity error;

        -- Test case 10: DP Reg (ANDS) Instruction
        t_Rd <= "1000"; t_Op <= "00"; t_Funct <= "000001";
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="10" and t_FlagW="10") report "Failed Decoder Test Case 10" severity error;

        -- Test case 11: DP Reg (ORR) Instruction
        t_Rd <= "1001"; t_Op <= "00"; t_Funct <= "011000";
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="11" and t_FlagW="00") report "Failed Decoder Test Case 11" severity error;

        -- Test case 12: DP Reg (ORRS) Instruction
        t_Rd <= "1010"; t_Op <= "00"; t_Funct <= "011001";
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_RegSrc="000" and t_NoWrite='0' and t_ALUControl="11" and t_FlagW="10") report "Failed Decoder Test Case 12" severity error;
        ...
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_RegSrc="000" and t_NoWrite='1' and t_ALUControl="01" and t_FlagW="11") report "Failed Decoder Test Case 21" severity error;
        ...
        wait for 5 ns;
        assert (t_PCS='1' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_RegSrc="000" and t_NoWrite='1' and t_ALUControl="01" and t_FlagW="11") report "Failed Decoder Test Case 23" severity error;
        ...
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_RegSrc="100" and t_NoWrite='0' and t_FlagW="00" and t_ALUResultSrc='1' and t_MCycleStart='1' and t_MCycleOp="01" and t_ALUControl="00") report "Failed Decoder Test Case 25.1" severity error;

        -- Test case 25.2: DP (MUL) Instruction
        -- S flag set, but MUL does not set any flags.
        t_Rd <= "----"; t_Op <= "00"; t_Funct <= "000001"; t_MCycleFunct <= "1001";
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_RegSrc="100" and t_NoWrite='0' and t_FlagW="00" and t_ALUResultSrc='1' and t_MCycleStart='1' and t_MCycleOp="01" and t_ALUControl="00") report "Failed Decoder Test Case 25.2" severity error;

        -- Test case 26.1: DP (DIV) Instruction
        t_Rd <= "----"; t_Op <= "00"; t_Funct <= "000010"; t_MCycleFunct <= "1001";
        wait for 5 ns;
        assert (t_PCS='0' and t_RegW='1' and t_MemW='0' and t_MemtoReg='0' and t_ALUSrc='0' and t_RegSrc="100" and t_NoWrite='0' and t_FlagW="00" and t_ALUResultSrc='1' and t_MCycleStart='1' and t_MCycleOp="11" and t_ALUControl="01") report "Failed Decoder Test Case 26.1" severity error;
